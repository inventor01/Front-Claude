...
function browserRuntime(){
 ...
 const enabled=localStorage.getItem(PUMPPORTAL_ENABLE_KEY)!=='false';
...
function scheduleReconnect(runtime){
 ...
 const delay=Math.min(30000,1000*2**runtime.attempt++);
...
function connect(runtime){
 ...
 socket.onopen=()=>{
  ...
  runtime.attempt=0;
  publish(runtime,'Connected · launches + migrations');
